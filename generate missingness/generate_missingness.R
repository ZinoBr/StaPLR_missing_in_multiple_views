  ...
  if (length(views) > 1) { 
    ...
    if (length(prop_na) == 1) {
      ...
      if (overlap == TRUE) {
        ...
        for (i in 1:length(views)) {
          ...
          if (i == 1) {
            ...
            ind_overlap = sample(ind_mult, length(ind_mult) / 2)
            
            # Combine overlapping indeces with newly sampled indeces
            ind_mult = c(ind_overlap , sample(n, length(ind_mult) / 2))
          }
      ...
      if (overlap == FALSE)  {
        ...
        ind = sample(pool , length(pool) * prop_na)
        ...
        for (i in 1:length(views)) {
          ...
          if (i == 1) {
            ...
            ind_mult = sample(pool , length(pool) * prop_na)
          }
      ...
      if (overlap == TRUE) {
        ...
        for (i in 1:length(views)) {
          ...
          if (i == 1) {
            ...
            # Use half of the sampled indeces from previous sample to introduce overlap
            ind_overlap = sample(ind_mult, n_indeces / 2)

...
# Train a model using pmm imputation at the meta level
time <- system.time(meta_pmm_fit <- staplr_meta_pmm(incomplete_data, view_index, 5))
...
save(results, file=paste0("/ ... /meta_pmm/", TID, ".RData"))
warnings()
